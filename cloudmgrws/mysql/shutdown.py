...
checks = {
    CHECK_PID_COMMAND                         	: 'pgrep -u $LOGNAME mysqld',
    STOP_COMMAND                        	: 'source $HOME/.bash_profile ; stop.sh',
    PKILL_COMMAND                           	: 'pkill -u $LOGNAME mysqld',
    KILL_COMMAND                            	: 'kill -9 $( pgrep -u $LOGNAME mysqld ) 2> /dev/null',
