...
checks = {
    ...
    STARTUP_COMMAND                        	: 'source $HOME/.bash_profile ; screen -f -U -A -d -m -S CLOUDMGRFTP su - cloudmgr --session-command " workon ftp_installer ; cd /home/cloudmgr/dev/ftp_installer/ftp_installer ; python ftp_installer.py"',
